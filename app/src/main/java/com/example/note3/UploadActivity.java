...
public class UploadActivity extends AppCompatActivity {
    ...
    public void saveData(){
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Изображение")
    ...
    public void uploadData(){
        ...
        FirebaseDatabase.getInstance().getReference("Пользователь").child(currentDate)
